...
HTML;
						...
						case 17:  // календарик:
                            $hidden_field = 1;
                            $field_html = <<<HTML
							<label><span class="label">{$form_fields[$field_name]['title']}{$required}</span></label>\n
		      ...
		      <img src="jscal/date_.gif" style="cursor:pointer" width="23" height="18" id="{$field_name}_img" 
			      alt="Выбрать дату" title="Выбрать дату"><br><br><hr>&nbsp;\n
HTML;
                            break;
...
HTML;
        ...
        if (CF_TYPE_PROJECT) {
        	 $t->assign(array(         	      
                 ...
                 'KOMUS_STEP_FIO'                => $call_data['Last_Name'].' '.$call_data['First_Name'].' '.$call_data['Patronymic'],                                           
